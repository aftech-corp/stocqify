            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="category_id" class="w-full border border-gray-300 rounded-lg text-sm px-3 py-2 outline-none">
                        ...
                        <option value="<?= $c['id'] ?>" <?= post('category_id')==$c['id']?'selected':'' ?>><?= h($c['name']) ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" rows="2"
                        ...
                        placeholder="Optional details..."><?= h(post('description')) ?></textarea>
                </div>
            </div>
            <div class="flex gap-3 mt-6">
                <button type="submit" class="bg-red-600 text-white px-6 py-2 rounded-lg text-sm font-medium hover:bg-red-700">
                    <i class="fa-solid fa-save mr-1"></i> Save Expense
                </button>
