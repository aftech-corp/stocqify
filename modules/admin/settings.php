...
function _dangerCategories(): array {
    return [
        ...
        'services'      => ['label' => 'Services & Orders',        'tables' => ['service_order_items', 'service_orders', 'services'],                               'icon' => 'fa-briefcase',        'desc' => 'Service catalogue, service orders and order items'],
        'debts'         => ['label' => 'Debts & Payments',         'tables' => ['debt_payments', 'debts', 'payments'],                                              'icon' => 'fa-coins',            'desc' => 'Debt records and payment history'],
        'finance'       => ['label' => 'Expenses & Income',        'tables' => ['expenses', 'income', 'expense_categories'],                                        'icon' => 'fa-wallet',           'desc' => 'Expense entries, income records and expense categories'],
        'drawings'      => ['label' => 'Owner Drawings',           'tables' => ['drawings'],                                                                        'icon' => 'fa-money-bill-wave',  'desc' => 'Owner withdrawal / drawing records'],
        'capital'       => ['label' => 'Capital Accounts',         'tables' => ['capital_accounts'],                                                                'icon' => 'fa-building-columns', 'desc' => 'Opening capital and capital injection records'],
        ...
        'auditlogs'     => ['label' => 'Audit / Activity Logs',    'tables' => ['audit_logs'],                                                                      'icon' => 'fa-scroll',           'desc' => 'All system activity and action history'],
        ...
        'subscriptions' => ['label' => 'Subscriptions & Features', 'tables' => ['business_subscriptions', 'business_features', 'user_feature_permissions'],         'icon' => 'fa-credit-card',      'desc' => 'Business plans, feature toggles and per-user permissions'],
